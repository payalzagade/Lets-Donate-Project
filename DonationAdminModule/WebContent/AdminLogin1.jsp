							...
							<div class="content-wthree1">
								       <div class="grid-w3layouts1">
											<div class="form-inline">
											   ...
											   <button style="font:bold;" type="submit" class="btn btn-default">Login</button>
				...
				<div class="container-fluid">
				 <div class="row">
				   <div class="col-12 beutify">
			     	<p class="copyright">© CharityPlus 2019<a href="www.cdac.com" target="_blank">CharityPlus</a></p>
                   </div>
     			 </div>
                </div>				
	    </div>
