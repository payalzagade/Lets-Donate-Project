...
<div style="height: 30px">
	...
	<h4>Orphanage Donation Form</h4>
	<div class="w3layouts">
		<div class="donate_form_w3l">
			<h5 class="center-w3ls">Donate Now</h5>
			<h2 class="center-w3ls">Would you like to donate Cloths?</h2>



			<spr:form action="donorClothRequest.htm" method="post" commandName="donor2">
				...
				<div class="left-agileinfo" id="clothdiv">

					<h5>Enter Cloths details</h5>

					<p>Number of Cloths</p>
					<spr:input path="quantity" id="" type="number" name="Name" />

					<p>Cloths Discription</p>
					<spr:input path="description" id=""
						class="form-control abc" rows="5" type="textarea" required=""/>
					<a href="donorClothSkip.htm" class="font-white" onclick="alertMsg()">Skip</a>
					<div class="clearfix"></div>

					<div id="submit">
						<input type="submit" value="Donate" onclick="alertMsg()">
					</div>
				</div>
			</spr:form>
			<div class="clear"></div>
		...
		<div class="footer-w3l">
			<p class="agileinfo">
				&copy; 2017 Orphanage Donation Form . All Rights Reserved | Design
				by <a href="http://w3layouts.com">W3layouts</a>
			</p>
		</div>
