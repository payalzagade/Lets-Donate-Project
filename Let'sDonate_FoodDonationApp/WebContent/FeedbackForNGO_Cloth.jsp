...
<body>
    ...
    <%if(session.getAttribute("username")==null){response.sendRedirect("index.jsp"); }else{ %>
	...
	<div class="w3layouts">
		...
		<spr:form action="FeedbackNGOCloth.htm" method="post" modelAttribute="response1">
           
        
          
		            <div id="Quetion1">

				           <label class="fontify">1.How was behaviour of NGO ?</label><br>
		            ...
		            <div id="Quetion2">
				               <label class="fontify">2.IS NGO on time ?</label><br>
		            ...
		            <div id="Quetion3">   
				           <label class="fontify">3.Have you continue with this NGO ?</label><br>
