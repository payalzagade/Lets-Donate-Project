...
<body>
 <%if(session.getAttribute("username")==null){response.sendRedirect("link.jsp"); }else{ %>
	<h1 style="color:black;">Feedback Form For Food</h1>
	<div class="w3layouts">
	<div class="donate_form_w3l">
			
	<spr:form action="Feedback_response_Food.htm" method="post" modelAttribute="response">
           
			
            
    	          <div id="Quetion1" >
				           <label class="fontify">1.How was food quality ?</label><br>
		    	   ...
		    	   <div id="Quetion2" class="mt-2">
				           <label class="fontify">2.Food is same as description or not?</label><br>
				   ...
				   <div id="Quetion4" class="mt-2">
			          <label class="fontify">Remarks..</label><br>
		                    <spr:textarea id="CommentId"  path="Comment"  cssStyle="background-color:white;font-size:20px;color:black" />
						...
						<input type="submit" value="submit" onclick="Feedback_response_Food.htm"></input>
				       
   	 </spr:form>
   
			         
				 </br>  	
		 <a href="Feedback_Book.htm">Skip</a>
