...
<body>
	...
	<div class="w3layouts">
		...
		<spr:form action="Feedback_response_Book.htm" method="post" modelAttribute="response">
           
          
                   
                     <div id="Quetion1" >
				           <label class="fontify">1.How was Book quality ?</label><br>
		            ...
		            <div id="Quetion2" class="mt-2">
				           <label class="fontify">2.Book is same as description or not?</label><br>
		            ...
		            <div class="rating" style="font-size:1px">
			         ...
			         <div id="Quetion4" class="mt-2">
		                   ...
		                   <label class="fontify">Remarks..</label>
		                    <spr:textarea id="CommentId"  path="Comment" cssStyle="background-color:white;font-size:20px;color:black" onchange="myFunction()"/>
		 ...
		 <a href="Feedback_Cloth.htm">Skip</a>
	...
	<div class="footer-w3l">
		<p class="agileinfo"> &copy; 2019Donation Website.All Rights Reserved | Design by <a href="https://www.facebook.com/">Let's Donate</a></p>
	</div>
	<%} %>
</body>
</html>