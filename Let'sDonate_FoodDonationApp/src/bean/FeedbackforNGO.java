...
@Entity
@Table(name="Response_Form_NGO")
public class FeedbackforNGO 
{
 @Id
...
public FeedbackforNGO(int responseId, int requestId, int categoryId, int nGOId, int donorId, String response1,
